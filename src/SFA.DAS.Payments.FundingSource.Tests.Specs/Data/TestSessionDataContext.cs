...
using SFA.DAS.Payments.FundingSource.Tests.Specs.Data.Configurations;
using SFA.DAS.Payments.FundingSource.Tests.Specs.Models;
using SFA.DAS.Payments.Model.Core.Audit;
using SFA.DAS.Payments.Model.Core.Entities;
using PaymentModelConfiguration = SFA.DAS.Payments.FundingSource.Tests.Specs.Data.Configurations.PaymentModelConfiguration;
using RequiredPaymentEventModelConfiguration = SFA.DAS.Payments.FundingSource.Tests.Specs.Data.Configurations.RequiredPaymentEventModelConfiguration;

namespace SFA.DAS.Payments.FundingSource.Tests.Specs.Data
{
    public class TestSessionDataContext : DbContext
    {
        ...
        public virtual DbSet<LevyAccountModel> LevyAccounts { get; set; }
        public virtual DbSet<ApprenticeshipModel> Apprenticeships { get; set; }
        public virtual DbSet<LevyTransactionModel> LevyTransactions { get; set; }
